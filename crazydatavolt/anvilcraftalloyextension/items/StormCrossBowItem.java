...
public class StormCrossBowItem extends CrossbowItem {
    ...
    public StormCrossBowItem(Properties properties) {
        super(properties);
    }
    ...
    protected void shootProjectile(
        ...
        projectile.shoot((double)vector3f.x(), (double)vector3f.y(), (double)vector3f.z(), velocity*1.4F, 0);
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> component, TooltipFlag flag) {
        component.add(Component.translatable("tooltip.anvilcraftalloyextension.storm_crossbow"));
    }
}
