...
public class ModBlockEntity {
    ...
    public static final Supplier<BlockEntityType<ExpansionBarrelBlockEntity>> EXPANSION_BARREL_ENTITY = BLOCK_ENTITYS.register("expansion_barrel",
            () -> BlockEntityType.Builder.of(ExpansionBarrelBlockEntity::new, ModBlocks.EXPANSION_BARREL_BLOCK.get()).build(null));
