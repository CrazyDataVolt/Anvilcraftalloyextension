...
public class ModTags {
    public static class Blocks{
        ...
        public static final TagKey<Block> CAULDRON_PIPE_SUPPORT=createTag("cauldron_pipe_support");

        public static final TagKey<Block> MINEING_ENCHANT_SUPPOT=createTag("mining_enchant_support");
    ...
    public static class Items{
        ...
        public static final TagKey<Item> SEED_FINDABLE=createTag("seed_findable");
