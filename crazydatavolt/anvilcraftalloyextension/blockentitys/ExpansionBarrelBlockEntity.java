...
public class ExpansionBarrelBlockEntity extends RandomizableContainerBlockEntity {//BarrelBlockEntity
    private NonNullList<ItemStack> items = NonNullList.withSize(54, ItemStack.EMPTY);
    private final ContainerOpenersCounter openersCounter = new ContainerOpenersCounter() {
        @Override
        protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
            ExpansionBarrelBlockEntity.this.playSound(p_155064_, SoundEvents.BARREL_OPEN);
            ExpansionBarrelBlockEntity.this.updateBlockState(p_155064_, true);
        }

        @Override
        protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
            ExpansionBarrelBlockEntity.this.playSound(p_155074_, SoundEvents.BARREL_CLOSE);
            ExpansionBarrelBlockEntity.this.updateBlockState(p_155074_, false);
        }
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == ExpansionBarrelBlockEntity.this;
            } else {
                return false;
            }
        }
    ...
    public ExpansionBarrelBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntity.EXPANSION_BARREL_ENTITY.get(),pos, blockState);
    }
